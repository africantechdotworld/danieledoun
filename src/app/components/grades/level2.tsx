                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-8">
                        ...
                        <div className="md:w-2/3">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="p-4 border border-gray-100 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <div className="max-w-3xl mx-auto">
                        {experience.map((job, index) => (
                            <div key={index} className="relative pl-8 pb-8">
                                {/* Timeline */}
                                <div className="absolute top-0 left-0 h-full w-px bg-blue-600"></div>
                                <div className="absolute top-0 left-0 w-4 h-4 -ml-2 rounded-full bg-blue-600 border-4 border-white dark:border-gray-800"></div>
