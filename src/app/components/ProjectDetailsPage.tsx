...
import { ChevronLeft, Github, Globe, Terminal, Calendar, User, ArrowRight } from 'lucide-react';
        ...
        <main className="min-h-screen pt-32">
            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-24">
                    ...
                    >
                        <div className="flex flex-wrap gap-2 mb-6 text-[10px] font-bold uppercase tracking-widest text-accent">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 p-8 bg-muted/30 rounded-[32px] border border-border/50">
                            <div>
                                <span className="text-xs uppercase tracking-widest text-muted-foreground font-bold block mb-2">Role</span>
                            ...
                            <div>
                                <span className="text-xs uppercase tracking-widest text-muted-foreground font-bold block mb-2">Year</span>
                                <span className="font-bold flex items-center gap-2 text-sm md:text-base">
                            ...
                            <div>
                                <span className="text-xs uppercase tracking-widest text-muted-foreground font-bold block mb-2">Tech</span>
                                <span className="font-bold flex items-center gap-2 text-sm md:text-base">
