...
import { Smartphone, Database, Palette, Globe } from 'lucide-react';
            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
                    <div className="max-w-xl">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">Technical Prowess</h2>
                        <p className="text-muted-foreground text-lg">
                            Combining cutting-edge technologies with thoughtful design to deliver robust digital solutions.
                        </p>
                    </div>
                    <div className="hidden md:flex gap-4">
                        <div className="flex flex-col items-center">
                            <span className="text-4xl font-bold">5+</span>
                            <span className="text-xs uppercase tracking-widest text-muted-foreground font-bold">Years exp.</span>
                        </div>
                        <div className="w-[1px] h-12 bg-border mx-4" />
                        <div className="flex flex-col items-center">
                            <span className="text-4xl font-bold">20+</span>
                            <span className="text-xs uppercase tracking-widest text-muted-foreground font-bold">Projects</span>
                        </div>
                    </div>
                </div>
